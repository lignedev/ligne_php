...
namespace Core\Util\HttpFoundation;

use Core\Util\HttpFoundation\Exception\ConflictingHeadersException;
use Core\Util\HttpFoundation\Exception\SuspiciousOperationException;
use Core\Util\HttpFoundation\Session\SessionInterface;
...
class Request
{
     ...
     * Custom parameters.
     *
     * @var \Core\Util\HttpFoundation\ParameterBag
     */
    public $attributes;
     ...
     *
     * @var \Core\Util\HttpFoundation\ServerBag
     */
    public $server;
     ...
     *
     * @var \Core\Util\HttpFoundation\FileBag
     */
    public $files;
     ...
     *
     * @var \Core\Util\HttpFoundation\HeaderBag
     */
    public $headers;
    ...
    /**
     * @var \Core\Util\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    public function isMethodSafe(/* $andCacheable = true */)
    {
        if (!\func_num_args() || func_get_arg(0)) {
            ...
            throw new \BadMethodCallException('Checking only for cacheable HTTP methods with Core\Util\HttpFoundation\Request::isMethodSafe() is not supported.');
        }
    ...
    private static function createRequestFromFactory(array $query = array(), array $request = array(), array $attributes = array(), array $cookies = array(), array $files = array(), array $server = array(), $content = null)
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Core\Util\HttpFoundation\Request.');
            }
